...
for i in range(100):
    ...
    x = 0.025 + 0.02*np.cos(i*np.pi/50)
    y = 0.025 + 0.02*np.sin(i*np.pi/50)
    depth = 0.001
    xy = [x, y, depth]
    ...
    # Save data
    np.save('rand/rawdata/response_circl_1_'+str(i), data)
    np.save('rand/rawdata/poses_circl_1_'+str(i), poses)
    np.save('rand/rawdata/times_circl_1_'+str(i), times)
    np.save('rand/rawdata/xy_circl_1_'+str(i), xy)
    np.save('rand/rawdata/temp_circl_1_'+str(i), float(temp))
...
for i in range(100):
    ...
    # Save data
    np.save('rand/rawdata/response_crossl_1_'+str(i), data)
    np.save('rand/rawdata/poses_crossl_1_'+str(i), poses)
    np.save('rand/rawdata/times_crossl_1_'+str(i), times)
    np.save('rand/rawdata/xy_crossl_1_'+str(i), xy)
    np.save('rand/rawdata/temp_crossl_1_'+str(i), float(temp))
...
for i in range(100):
    ...
    # Save data
    np.save('rand/rawdata/response_circl_4_'+str(i), data)
    np.save('rand/rawdata/poses_circl_4_'+str(i), poses)
    np.save('rand/rawdata/times_circl_4_'+str(i), times)
    np.save('rand/rawdata/xy_circl_4_'+str(i), xy)
    np.save('rand/rawdata/temp_circl_4_'+str(i), float(temp))
...
for i in range(100):
    ...
    # Save data
    np.save('rand/rawdata/response_crossl_4_'+str(i), data)
    np.save('rand/rawdata/poses_crossl_4_'+str(i), poses)
    np.save('rand/rawdata/times_crossl_4_'+str(i), times)
    np.save('rand/rawdata/xy_crossl_4_'+str(i), xy)
    np.save('rand/rawdata/temp_crossl_4_'+str(i), float(temp))
