...
#
#     # Save data
#     np.save('patt/rawdata/response_circl2_1_'+str(i), data)
#     np.save('patt/rawdata/poses_circl2_1_'+str(i), poses)
#     np.save('patt/rawdata/times_circl2_1_'+str(i), times)
#     np.save('patt/rawdata/xy_circl2_1_'+str(i), xy)
#     np.save('patt/rawdata/temp_circl2_1_'+str(i), float(temp))
#
#     print(i)
...
for i in range(100):
    ...
    # Save data
    np.save('patt/rawdata/response_crossl3_1_'+str(i), data)
    np.save('patt/rawdata/poses_crossl3_1_'+str(i), poses)
    np.save('patt/rawdata/times_crossl3_1_'+str(i), times)
    np.save('patt/rawdata/xy_crossl3_1_'+str(i), xy)
    np.save('patt/rawdata/temp_crossl3_1_'+str(i), float(temp))
...
#
#     # Save data
#     np.save('patt/rawdata/response_circl2_4_'+str(i), data)
#     np.save('patt/rawdata/poses_circl2_4_'+str(i), poses)
#     np.save('patt/rawdata/times_circl2_4_'+str(i), times)
#     np.save('patt/rawdata/xy_circl2_4_'+str(i), xy)
#     np.save('patt/rawdata/temp_circl2_4_'+str(i), float(temp))
#
#     print(i)
...
for i in range(100):
    ...
    # Save data
    np.save('patt/rawdata/response_crossl3_4_'+str(i), data)
    np.save('patt/rawdata/poses_crossl3_4_'+str(i), poses)
    np.save('patt/rawdata/times_crossl3_4_'+str(i), times)
    np.save('patt/rawdata/xy_crossl3_4_'+str(i), xy)
    np.save('patt/rawdata/temp_crossl3_4_'+str(i), float(temp))
